...
public class Arqueiros2 : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag != "GrassL" && collision.gameObject.tag != "GrassLM" && collision.gameObject.tag != "GrassM" && collision.gameObject.tag != "GrassRM" && collision.gameObject.tag != "GrassR" && collision.gameObject.tag != "StopArchers2" && collision.gameObject.tag != "Ground")
        {
        ...
        if (collision.gameObject.tag == "GrassR")
        {
            currentArea = 5;
        }
    }
