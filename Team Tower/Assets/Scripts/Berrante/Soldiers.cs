...
public class Soldiers : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag != "GrassL" && collision.gameObject.tag != "GrassLM" && collision.gameObject.tag != "GrassM" && collision.gameObject.tag != "GrassRM" && collision.gameObject.tag != "GrassR" && collision.gameObject.tag != "Castle2Bot" && collision.gameObject.tag != "Ground")
        {
            Physics2D.IgnoreCollision(collision.gameObject.GetComponent<Collider2D>(), GetComponent<Collider2D>());
        }
        if (collision.gameObject.tag == "Castle2Bot")
        {
